<?php
// views/admin/habitaciones/listado_view.php
...
<div class="container mt-4">
    ...
    <a href="index.php?controller=habitacionesAdmin&action=create" class="btn btn-primary mb-3">Nueva Habitación</a>
            ...
            <?php else: ?>
                <?php foreach ($habitaciones as $h): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?controller=habitacionesAdmin&action=edit&id=<?= $h['id'] ?>" class="btn btn-sm btn-warning">Editar</a>
                            <a href="index.php?controller=habitacionesAdmin&action=delete&id=<?= $h['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar esta habitación?');">Eliminar</a>                        
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
